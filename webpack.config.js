...
if (process.env.NODE_ENV === 'production' || process.env.NODE_ENV === 'production_fast') {
	...
	WebpackExport.plugins.push(
		new PrerenderSpaPlugin(
			path.join(__dirname, ''),
			['/fr', '/en', '/fr/projects', '/en/projects', '/fr/boursify', '/en/boursify', '/fr/projects/mcc', '/en/projects/mcc', '/fr/projects/occ', '/en/projects/occ', '/fr/projects/save', '/en/projects/save', '/fr/projects/jussaume', '/en/projects/jussaume', '/fr/projects/coupsur', '/en/projects/coupsur', '/fr/projects/elium', '/en/projects/elium', '/fr/careers', '/en/careers', '/en/career/design', '/fr/career/design', '/en/career/developper', '/fr/career/developper', '/fr/about', '/en/about', '/fr/contact', '/en/contact'],
			{
