export default {
	"design": {
		...
		"content": {
			...
			"skills": [
				"Habile avec Photoshop, Illustrator et/ou Sketch",
				"Expérience dans le design web",
			],
			"assets": [
				"Compétences en HTML, CSS ou Javascript",
				"Connaitre inVision",
				"Être une personne passionnée, enthousiaste et curieuse",
			]
		}
	},
	"developper": {
